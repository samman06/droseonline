    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div *ngIf="!isLoading && !assistant" class="max-w-4xl mx-auto px-4 py-12">
        <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
          ...
          <p class="text-gray-600 mb-6">The assistant you're looking for doesn't exist or you don't have permission to view it.</p>
      ...
      <div *ngIf="!isLoading && assistant" class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
          ...
          <div class="flex items-center justify-between">
            <h1 class="text-3xl font-bold text-gray-900">Assistant Details</h1>
          ...
          <div class="bg-gradient-to-r from-blue-500 to-indigo-500 p-8 text-white">
            <div class="flex items-center gap-6">
              ...
              <div class="flex-1">
                ...
                <p class="text-blue-200 text-sm mt-2">Joined {{ formatDate(assistant.createdAt) }}</p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div>
                      <p class="text-xs font-semibold text-gray-500 uppercase">Assigned Date</p>
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div>
                      <p class="text-xs font-semibold text-gray-500 uppercase">Created</p>
            ...
            <div class="border-t pt-8">
              ...
              <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                <p class="text-sm text-green-800 font-medium">
                  ✅ This assistant has <strong>full teaching access</strong> to all features below
                </p>
              </div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <div class="flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <span class="text-sm font-medium text-gray-900">Manage Assignments</span>
                </div>
                <div class="flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg p-4">
                  <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                  </svg>
                  <span class="text-sm font-medium text-gray-900">Manage Materials</span>
                </div>
                <div class="flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg p-4">
                  <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                  </svg>
                  <span class="text-sm font-medium text-gray-900">View Students</span>
                </div>
                <div class="flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg p-4">
                  <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                  </svg>
                  <span class="text-sm font-medium text-gray-900">Manage Announcements</span>
                </div>
                <div class="flex items-center gap-3 bg-green-50 border border-green-200 rounded-lg p-4">
                  <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
              ...
              <div class="mt-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-r-lg">
                <div class="flex items-start gap-3">
                  ...
                  <div class="flex-1">
                    <p class="font-semibold text-gray-900 mb-1">⛔ No Accounting Access</p>
                    <p class="text-sm text-gray-700">
                      Assistants cannot access any financial or accounting features, including payments, revenue reports, and financial data.
                    </p>
                  </div>
                </div>
              </div>
